#line 1 "..\\Hardware\\led\\bsp_led.c"


#line 1 "..\\Hardware\\led\\bsp_led.h"
...
void led_gpio_config(void)
{
	...
	gpio_mode_set(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00001000U),(((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)),(((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)),((uint32_t)((uint32_t)0x01U<<(3))));
	 
	gpio_output_options_set(((((uint32_t)0x40020000U) + 0x00000000U) + 0x00001000U),((uint8_t)(0x00U)),(((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0)),((uint32_t)((uint32_t)0x01U<<(3))));
}

...
#include <stdio.h>
	...
	#define SystemCoreClock 240000000 //240MHz
#endif
...
//#define configSYSTICK_CLOCK_HZ                          (SystemCoreClock / 8)/* 定义SysTick时钟频率，当SysTick时钟频率与内核时钟频率不同时才可以定义, 单位: Hz, 默认: 不定义 */
...
#define configTOTAL_HEAP_SIZE                           ((size_t)(50 * 1024))   /* FreeRTOS堆中可用的RAM总量, 单位: Byte, 无默认需定义 */
